...
make -C /home/praveen/deviceDrivers/03_DynModOutTree/linux-6.1.4/ M=${PWD} ARCH=arm \ CROSS_COMPILE=arm-linux-gnueabi- modules

# make a directory called rootfs in /mnt, this mostly has to be made in terminal by ourself
