...
make -C /home/praveen/deviceDrivers/07_CharDriverReadWrite/linux-6.1.4/ M=${PWD} ARCH=arm \ CROSS_COMPILE=arm-linux-gnueabi- modules
...
sudo rm /mnt/rootfs/home/root/*.ko
sudo cp char_driver3.ko /mnt/rootfs/home/root/
